...
module.exports = function (SERVICE_NAME, CONNECTION_NAME, setupOpts) {
    let conf = {
        initSimultaneousRequests: 10, // Starts prefetch at this values and goes up to simultaneousRequests
        simultaneousRequests: 500, // Channel level default prefetch. It overrules Q_REQUESTS.limit's consumer prefetch
