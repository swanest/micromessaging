...
//todo:force close connection (even if there are pending unhandled messages)
//todo : better manage the channel error 'no forthcoming reply...' (often due to a re-attempt of using the same consumer-tag, during subscribe)
